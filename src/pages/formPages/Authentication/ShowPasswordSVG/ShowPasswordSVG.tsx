import styles from './ShowPasswordSVG.module.scss'
...
const ShowPasswordSVG: FC<ShowPasswordSVGProps> = ({showIf, showPassword, setShowPassword}) => {
    return (
        <>
            {
                //svg глаза для показа пароля
                showIf && <div title={'Show password'} className={styles.showPasswordSvg}>
                    {
                        showPassword ?
